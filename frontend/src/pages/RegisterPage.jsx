...
export default function RegisterPage() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      sessionStorage.setItem('qnect_pending_registration', JSON.stringify(registrationData));
      ...
      >
        ...
        <div className="flex-1 p-8 md:p-12 flex flex-col justify-center">
          ...
          <div className="text-center mb-10">
            <h2 className="text-3xl font-black tracking-tight text-gray-900 mb-2 font-['Outfit']">Create Account</h2>
            <p className="text-gray-500 text-sm font-medium">Join our community today</p>
          </div>
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <div className="relative">
              ...
              <input
                type="text"
                className={`w-full pl-12 pr-10 py-3.5 bg-gray-50/50 border rounded-2xl focus:outline-none focus:ring-4 transition-all placeholder-gray-400 text-gray-900 font-medium focus:bg-white ${usernameStatus.available === true
                  ...
                  : usernameStatus.available === false
                    ...
                    : 'border-gray-200 focus:ring-rose-500/10 focus:border-rose-400'
                  }`}
